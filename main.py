...
dic_xpats_kayak = {
    ...
    'Origin place': ["//div[contains(@class, 'result-item-container')][{quantity_flights}]//div[contains(@class,'mod-variant-large')]//following-sibling::div/div/div[1]/span/span[2]"],
    'Destination place': ["//div[contains(@class, 'result-item-container')][{quantity_flights}]//div[contains(@class,'mod-variant-large')]//following-sibling::div/div/div[2]/span/span[2]"],
